...
require('./candra.js')
nocache('./candra.js', module => console.log(`${module} Telah Di Perbarui!`))
require('./main.js')
...
const starts = async (kuza = new WAConnection()) => {
    ...
    kuza.browserDescription = ['CandraBot','Chrome', '3.0']
    console.log(banner)
console.log(color('🌀[ BASE BY CandrafI ]'))
    kuza.on('qr', () => {
...
teks = `https://chat.whatsapp.com/JJ2lxeH6LPb9BW6b15nXL5` 
...
kuza.on('chat-update', async (message) => {
        require('./candra.js') (kuza, message, _welkom)
    })
...
function nocache(module, cb = () => { }) {
    console.log(color('Module', 'green'), color(`'${module} Dipantau Oleh Candra'`, 'cyan'))
