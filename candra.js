...
let botname = '*_｢ Candra-Boot ｣ 冬_*'
let lolkey = 'isi'
let zekskey = '77DrbX6zgL2FdPinQK07Mwn2TlkSA0j1cTFZdW66QSs' //Ganti Pake Api Lu Sendiri Biar Limitnya Gak Cepet Abis , Login Di zeks.me Untuk Mendapatkan Api Gratis
let ownername = '*_｢ Candrafl ✘ ｣_*' //NAMA OWNER
let owner = '6289670004720' // NOMOR OWNER
let symbol = '*🦅*'
let faketeks = `*_｢ Candra-Boot ｣ 冬_*` 
...
const fakeyt = (teks) => { 
kuza.sendMessage(from, teks, text,{contextInfo :{text: 'hi', "forwardingScore": 1000000000, isForwarded: false, sendEphemeral: false, "externalAdReply": { "title": `hallo ${pushname}🗿` , "body": `YT : Candrafl`, "mediaType": "2", "thumbnailUrl": "https://c.top4top.io/p_2087f30hj1.jpeg", "mediaUrl": "https://tps.com/channel/UCJPqI5eVhKPXPL2V8y6pIDA", "thumbnail": fs.readFileSync('./media/pee.jpg'), "sourceUrl": "", },mentionedJid:[sender]}, quoted : fstatus})};
...
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "YT : Candra-Bot", 'jpegThumbnail': fs.readFileSync('./media/pee.jpg')}}}
...
run = process.uptime();
 ...
 footerText: '🌀 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Candrafl',
...
case 'bc':
			...
			"footerText": 'CandraBot by Candrafl',
			"buttons": [
...
case 'groupbot':
reply(`https://chat.whatsapp.com/JJ2lxeH6LPb9BW6b15nXL5`)
break
